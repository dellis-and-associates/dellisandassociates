...
| Header, hero, footer | Chromium, 4× CPU, Slow 4G | 320 · 768 · 1280 · 1920 | `shell:shots` before and after | `docs/ux-audit/shell/{before,after}/`: 16 files each, looked at; findings in `UX-AUDIT.md`, removals in `CRITIQUE.md` (2026-09-13/14) |
