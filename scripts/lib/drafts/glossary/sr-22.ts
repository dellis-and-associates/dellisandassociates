...
export const draft: GlossaryDraft = {
  ...
  inPractice: ["The state tells the driver when a filing is required and for how long: {{TODO:statute.arizona.sr22-filing-period}}. The carrier files it and must notify the state if the policy cancels, which is why a lapse during the filing period restarts the clock. Not every carrier files them, and a filing usually raises the premium because of the record behind it. A driver who does not own a car can satisfy it with a non-owner policy."],
