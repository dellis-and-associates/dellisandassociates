...
export const draft: GlossaryDraft = {
  ...
  inPractice: [
    "Each state sets a rule, either a fixed share of the vehicle's pre-accident value or a formula that adds salvage value to repair cost; the figure for Arizona is {{TODO:statute.arizona.total-loss-threshold}}. Carriers may also declare a total below that point when repair cost plus rental and the risk of hidden damage exceed what the car is worth. Once declared, the owner is paid actual cash value less the deductible, the lender is paid first, and the vehicle receives a salvage title. An owner who keeps the car receives the value minus what the salvage would have fetched. Gap coverage matters here for financed cars. The valuation can be disputed with comparable listings.",
  ],
  example: [
