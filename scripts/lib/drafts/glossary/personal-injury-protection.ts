...
export const draft: GlossaryDraft = {
  ...
  inPractice: [
    "Utah requires it; Arizona, Nevada and Idaho do not, and in those states carriers offer medical payments coverage instead or as well. Where it is required, the state sets a minimum benefit and drivers can buy more: {{TODO:statute.utah.pip-minimum-benefit}}. It pays quickly because there is no fault argument, and it coordinates with health insurance in a way that varies by carrier: some pay first, some pay after the health plan. Wage replacement is capped and usually starts after a short waiting period. A driver hurt as a pedestrian is covered by their own auto PIP, which surprises people. Buying only the minimum is common and usually a mistake for anyone whose health plan has a high deductible.",
  ],
  example: [
