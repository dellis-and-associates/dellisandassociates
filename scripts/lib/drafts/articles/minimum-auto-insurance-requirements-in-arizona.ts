...
export const draft: ArticleDraft = {
  ...
  excerpt: "What Arizona requires a driver to carry, how the state checks, what happens when a policy lapses, and why the required minimums are a floor rather than a recommendation. Every statutory figure is cited to the Department of Insurance and Financial Institutions.",
  sections: [
    {
      heading: "",
      paragraphs: [
        "Arizona requires every registered vehicle to carry liability insurance, and it checks. The figures below are the ones the state sets by statute; we publish each one only with its citation, and where our verification against the state's own text is still in progress the figure is marked rather than guessed. The Department of Insurance and Financial Institutions publishes the current requirements at https://difi.az.gov/.",
    ...
    },
    {
      ...
      paragraphs: [
        "The required coverage is liability only: what you owe other people for injuries and property damage in an accident you cause. Arizona sets a per-person bodily injury limit of {{TODO:statute.arizona.auto-bi-per-person}}, a per-accident bodily injury limit of {{TODO:statute.arizona.auto-bi-per-accident}}, and a property damage limit of {{TODO:statute.arizona.auto-pd}}. Written the way carriers print it, that is the familiar three-number form on a declarations page.",
        "Nothing in the requirement pays for your own car, your own injuries, or an accident caused by a driver with no insurance. Collision, comprehensive, medical payments and uninsured motorist coverage are all separate purchases. Whether a carrier must offer uninsured and underinsured motorist coverage, and whether you may reject it in writing, is set by {{TODO:statute.arizona.um-uim-offer-rule}}.",
      ],
    },
    {
      heading: "How the state checks",
      paragraphs: [
        "Arizona runs an electronic verification program: carriers report policies to the state, and the state matches them against registrations. A vehicle whose policy is reported cancelled and not replaced is flagged, and the owner receives notice to prove coverage. The mechanics and the notice period are set by the state: {{TODO:statute.arizona.insurance-verification-program}}.",
    ...
    },
    {
      ...
      paragraphs: [
        "Every limit in this article is either cited to the Department of Insurance and Financial Institutions at https://difi.az.gov/ or marked as a token waiting on our verification against the current statute. When a token is filled, the page records the date it was checked. Arizona changes these figures by legislation, not often, but when it does the old figure is wrong the next day; the citation is the only way to know which one you are reading.",
