...
export const draft: PageDraft = {
  ...
  lede: "Desert Peak Insurance is licensed as an insurance producer in Arizona. The license, the lines it covers and the regulator that issued it are set out below.",
  blocks: [
    {
      type: "richText",
      sections: [
