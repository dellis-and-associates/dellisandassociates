...
export const draft: PageDraft = {
  ...
  lede: "{{TODO:site.legalName}} is a licensed insurance producer in Idaho. The license is disclosed below, along with the Idaho Department of Insurance, which issued it.",
  blocks: [
    {
      type: "richText",
      sections: [
