...
| 14 | The one `CityFacts` field that needs the office: nearest office or agent for each of the 38 cities. The other six fields were researched and filled on 2026-09-15 (real neighborhoods, hazards, housing, driving, local rules) and are part of the review pass. City pages stay `noindex` until this field is filled. | 2026-09-12 | 380 Tier-1 city pages (uniqueness gate) |
