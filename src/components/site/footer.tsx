...
/**
 * Footer on surface-inverse. Mono column headings, hairline dividers, links and disclosures at body size —
  ...
  return (
    <footer data-inverse className="mt-16 bg-logo-ground-inverse text-ink-inverse [overflow-wrap:anywhere] print:hidden">
      <div className="shell grid gap-10 py-20 md:grid-cols-3 lg:grid-cols-[2fr_1fr_1fr_1fr_1fr_1fr] lg:gap-0">
        ...
        <nav aria-label="Insurance" className={`${col} lg:border-l lg:border-ink-inverse/25 lg:pl-6`}>
        ...
        <nav aria-label="Licensed in" className={`${col} lg:border-l lg:border-ink-inverse/25 lg:pl-6`}>
        ...
        <nav aria-label="Resources" className={`${col} lg:border-l lg:border-ink-inverse/25 lg:pl-6`}>
        ...
        <nav aria-label="For partners" className={`${col} lg:border-l lg:border-ink-inverse/25 lg:pl-6`}>
        ...
        <nav aria-label="Legal" className={`${col} lg:border-l lg:border-ink-inverse/25 lg:pl-6`}>
