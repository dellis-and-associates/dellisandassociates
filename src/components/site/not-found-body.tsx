...
export function NotFoundBody() {
  return (
    <div className="mx-auto grid max-w-measure-page gap-8 px-4 py-16 md:px-8">
      ...
      <form action="/search/" method="get" role="search" aria-label="Search from this page" className="flex max-w-measure-narrow gap-2">
        ...
        <input id="nf-q" name="q" type="search" className="min-h-11 flex-1 rounded-control border border-border-strong bg-surface-raised px-3 font-sans text-small" placeholder="Search products, places and terms" />
