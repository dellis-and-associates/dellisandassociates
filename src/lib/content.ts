...
export const getArticles = () => cachedFind(["articles"], ["articles"], async () => (await (await db()).find({ collection: "articles", limit: 0, pagination: false, depth: 0, sort: "title" })).docs as Article[]);
