...
export default async function Carriers() {
  ...
  return (
    <div className="mx-auto grid max-w-measure-shell gap-10 px-gutter py-10">
      ...
      {carriers.length === 0 ? <EmptyState title="Ask which carriers write your line" action={{ label: "Request a quote", href: "/quote/" }}>As an independent agency we place coverage with the carriers we are appointed with. The analysis shows which of them write your line in your state, side by side.</EmptyState> : (
