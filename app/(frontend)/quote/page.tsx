...
export const metadata = pageMetadata({ title: "Request a quote", description: "Tell us what to compare. Four short steps, saved as you go.", path: "/quote/", indexable: false });
