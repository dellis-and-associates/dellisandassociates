    ...
    <div className="mx-auto grid max-w-measure-page gap-6 px-4 py-16 md:px-8">
      <div className="grid max-w-measure-narrow gap-6">
        ...
        <form action={sendMagicLink} method="post" className="grid gap-4">
          ...
          <button className="inline-flex min-h-11 w-fit items-center rounded-control bg-brand px-5 font-sans text-small font-semibold text-brand-ink hover:bg-brand-hover">Email me a sign-in link</button>
        </form>
